...
public class Product {
	...
	public Product(String prodC, String prodN,String prodL, String prodS, String prodV, String prodD,int quantIS, double buyP, double msrp){
